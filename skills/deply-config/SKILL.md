---
name: deply-config
description: Use when creating, auditing, validating, or integrating Deply v1.1.3 architecture configuration files for Python projects, including deply.yaml, light/medium/strict guidance, monorepos, CI, Makefiles, and architecture documentation.
license: MIT
metadata:
  version: "1.1.3"
---
...
3. Read the needed references:
   ...
   - `references/deply-v1-schema.md` for exact Deply v1.1.3 YAML, collectors, rules, and validation constraints.
